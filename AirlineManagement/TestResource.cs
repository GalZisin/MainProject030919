...
namespace AirlineManagement
{
    public class TestResource
    {
        ...
        public static DateTime AnonymousFacade_DEPARTURE_TIME = DateTime.ParseExact("2019-07-08 12:00:00", "yyyy-MM-dd HH:mm:ss", null);
        public static DateTime AnonymousFacade_LANDING_TIME = DateTime.ParseExact("2019-07-08 18:00:00", "yyyy-MM-dd HH:mm:ss", null);
        public const int AnonymousFacade_REMANING_TICKETS = 100;
        public const int AnonymousFacade_TOTAL_TICKETS = 100;
